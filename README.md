...
`bsbctl` connects BUSY Bar to local tools and services on macOS. It shows Calendar events, Codex activity and quota, GitHub notifications, and Mac resource usage.
...
| **GitHub Notifications** | **Mac Resources** |  |
| ![GitHub Notifications app showing mock review requests and mentions on a BUSY Bar](docs/previews/github-notifications-front.gif) | ![Mac Resources app showing fixed mock CPU, memory, and network readings on a BUSY Bar](docs/previews/mac-resources-front.gif) |  |
