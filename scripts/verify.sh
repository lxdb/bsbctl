...
run_preview() {
  ...
  root_go test -mod=readonly -tags preview ./plugins/calendar ./plugins/codex ./plugins/codexquota ./plugins/githubnotifications ./plugins/macresources ./plugins/slack -run Preview -shuffle=on -count=1
}
