...
func TestRunReleaseTagsEmitsEveryValidatedTagAsFetchRefspec(t *testing.T) {
	...
	want := []string{
		...
		"refs/tags/plugin/calendar/v0.2.0:refs/tags/plugin/calendar/v0.2.0",
		"refs/tags/plugin/codex/v0.2.0:refs/tags/plugin/codex/v0.2.0",
		"refs/tags/plugin/codex-quota/v0.2.0:refs/tags/plugin/codex-quota/v0.2.0",
		"refs/tags/plugin/github-notifications/v0.1.0:refs/tags/plugin/github-notifications/v0.1.0",
		"refs/tags/plugin/mac-resources/v0.2.0:refs/tags/plugin/mac-resources/v0.2.0",
